...
> FootageItem is a subclass of [AVItem object](avitem.md), which is a subclass of [Item object](index.md). All methods and attributes of AVItem and Item, in addition to those listed below, are available when working with FootageItem.
