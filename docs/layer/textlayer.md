...
> TextLayer is a subclass of [AVLayer](avlayer.md), which is a subclass of [Layer](index.md). All methods and attributes of AVLayer and Layer are available when working with TextLayer.
